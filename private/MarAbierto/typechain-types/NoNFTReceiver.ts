...
export interface NoNFTReceiverInterface extends utils.Interface {
  functions: {
    "mint()": FunctionFragment;
    "nftAddress()": FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: "mint" | "nftAddress"): FunctionFragment;
...
export interface NoNFTReceiver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NoNFTReceiverInterface;
